    ...
    mounted: function () {
      ...
      this.$http.get(this.$store.state.CHINA_MAP_JSON)
        .then(function (chinaJson) {
          ...
          this.$http.get(this.$store.state.BASE_URL + '/impCityThiInduAddedIndex')
...
//                var  min2 = ~~getCurrentYearMinValue(timeLine[0]) -10
                ...
                option = {
                  ...
                  title: [
                    {
                      text: '产业指数-'+timeLine[0]+'年第三产业增加值(亿元)',
                      subtext: '锐信视界',
...
//                  }
                  ...
                  geo: {
                    ...
                    left: '10',
                    right: '35%',
                    center: [116.98561551896913, 32.205000490896193],
                    zoom: 2.3,
                    label: {
                      emphasis: {
                        show: false
