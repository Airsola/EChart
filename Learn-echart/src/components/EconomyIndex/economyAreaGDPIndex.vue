...
//          };
              ...
              lastYearData =  data = sort_object(lastYearData);

              var object2ObjectArry = [];

              for (var k in lastYearData) {
                var obj = new Object();
                obj.name = k;
                obj.value = lastYearData[k];
                object2ObjectArry.push(obj);
                console.log(k, ':', lastYearData[k]);
              }
              debugger;

              //对对象进行降序排序
              var sortedObjectArry =[]
//          sortedObjectArry = sort_object(object2ObjectArry, 'value', true);
//          for (let obj  of sortedObjectArry) {
//  console.log("agab" +obj.name + obj.value)
//          }
...
//              splitNumber: 10,
                ...
                yAxis: {
                  ...
                  data: Object.keys(lastYearData) //这里需要使用倒序排列后的数据
                },
              ...
              //------------------------------
                ...
                console.log('服务器暂时无法访问 '+response)
              })
