...
//----------
        ...
        function showMap(lv, name) {
          ...
          if (lv == 1) {
            $.get('http://7xlgc1.com1.z0.glb.clouddn.com/china.json', function (json) {
              echarts.registerMap('china', json);
              option.series[0].mapType = "china";
              myecharts.setOption(option);
              myecharts.on("mapselectchanged", function (param) {
            ...
            if (typeof py != "undefined") {
              $.get('http://cbxjj.cn/demo/' + 'province/' + py + '.json', function (json) {
                echarts.registerMap(name, json);
                option.series[0].mapType = name;
                myecharts.setOption(option);
                myecharts.on("mapselectchanged", function (param) {
                  showMap(3, param.name);
                });
              });
            }
          } else {
            var py = cityMap[name];
            if (typeof py != "undefined") {
              $.get('http://cbxjj.cn/demo/' + 'city/' + py + '.json', function (json) {
                echarts.registerMap(name, json);
                option.series[0].mapType = name;
                myecharts.setOption(option);
                myecharts.on("mapselectchanged", function (param) {
